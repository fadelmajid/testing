...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-12">
        <h2><?php echo $title_form;?> Voucher Gift</h2>
    </div>
</div>
        ...
        <?php if ($show_form): ?>
            <div class="ibox">
                <div class="ibox-content" style="">
                    ...
                    <div class="form-group">
                        <h5>Quantity</h5>
                        <input type="text" class="form-control" name="qty" placeholder="max quantity is 500" value="<?php echo set_value('qty');?>" id="qty" require>
                        <?php echo form_error('qty'); ?>
                    </div>
                    <div class="form-group">
                        <h5>Expired Date</h5>
                        <input class="form-control" name="exp_date" id="exp_date" value="<?php echo set_value('exp_date');?>">
