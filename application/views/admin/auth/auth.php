                ...
                <div class="ibox-content">
                    ...
                    <table class="table table-sticky table-bordered">
                        <thead>
                            <tr>
                                <th>
                                    <?php echo sort_table_icon($page_url, 'id', 'Code ID', $xtra_var); ?>
                                </th>
                                <th>
                                    <?php echo sort_table_icon($page_url, 'phone', 'Customer No', $xtra_var); ?>
                                </th>
                                <th>
                                    <?php echo sort_table_icon($page_url, 'secret', 'Secret Code', $xtra_var); ?>
                                </th>
                                <th>
                                    <?php echo sort_table_icon($page_url, 'status', 'Code Status', $xtra_var); ?>
                                </th>
                                <th>
                        ...
                        <tbody>
                            ...
                            foreach ($all_data as $key => $value) {
                                echo '
                                    <tr id="tr_'. $value->acode_id .'">
                                        <td>'.$value->acode_id.'</td> 
                                        <td>'.$value->acode_phone.'<br>
                                        <td>'.$value->acode_secret.'</td>
                                        <td><strong>'.$value->acode_status.'</strong></td>
