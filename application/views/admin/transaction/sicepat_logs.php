                        ...
                        <tbody>
                            <?php
                                ...
                                foreach ($all_data as $value){
                                    echo '
                                        <tr>
                                            <td>'. $value->sicepat_id .'</td>
                                            <td>'. $value->sicepat_type .'</td>
                                            <td>'. show_date($value->created_date, true) .'</td>
                                            <td>'. $value->sicepat_endpoint .'</td>
                                            <td>
                                                <a href="#" data-clipboard-target="#header'.$value->sicepat_id.'" id="sicepat">'. substr($value->sicepat_header, 0, 50) .'</a>
                                                <textarea id="header'. $value->sicepat_id .'" style="opacity: .01;height:0;position:absolute;z-index: -1;">'. $value->sicepat_header .'</textarea>
                                            </td>
                                            <td>
                                                <a href="#" data-clipboard-target="#request'.$value->sicepat_id.'" id="sicepat">'. substr($value->sicepat_request, 0, 50) .'</a>
                                                <textarea id="request'. $value->sicepat_id .'" style="opacity: .01;height:0;position:absolute;z-index: -1;">'. $value->sicepat_request .'</textarea></td>
                                            <td>
                                                <a href="#" data-clipboard-target="#response'.$value->sicepat_id.'" id="sicepat">'. substr($value->sicepat_response, 0, 50) .'
                                                <textarea id="response'. $value->sicepat_id .'" style="opacity: .01;height:0;position:absolute;z-index: -1;">'. $value->sicepat_response .'</textarea>
                                            </td>
                                        </tr>
                                    ';
                                }
