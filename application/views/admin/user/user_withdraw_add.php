...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-12">
        <h2><?php echo $title_form;?> User Withdraw</h2>
    </div>
</div>
            ...
            <div class="ibox">
                <div class="ibox-content" style="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" value="<?php echo ($user ? $user->user_email : '');?>" data-parsley-type="email" id="autocomplete-email" require />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="uwal_balance" value="<?php echo set_value('uwal_balance', ($user ? $user->uwal_balance : ''));?>" id="uwal_balance" disabled>
                    </div>
                    <div class="form-group">
                        <h5>Nominal</h5>
                        <select class="form-control m-b" name="uwd_nominal" id="utop_nominal">
                            <?php
                                foreach($cst_user['nominal'] as $key => $val){
                                    echo '<option value="'. $key.'" '. (set_value('uwd_nominal') == $key ? 'selected' : '') .'>'. number_format($val) .'</option>';
                                }
                            ?>
                        </select>
                        <?php echo form_error('uwd_nominal'); ?>
                    </div>
...
<script>
        ...
        $("#submit").click(function () {
            ...
            var confirm_action  = confirm('Withdraw '+ utop_nominal +' from '+ name +'\'s wallet. This process can\'t be undo. Are you sure want to process this Withdraw?');
